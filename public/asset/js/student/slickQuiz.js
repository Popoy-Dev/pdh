                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        for (i in answers) {
                            if (answers.hasOwnProperty(i)) {
                                ...
                                var input = '<input id="' + optionId + '" name="' + inputName +
                                            '" type="' + inputType + '" class="radio_active" value="'+answer.option+'" data-qid="'+question.id+'" data-said="'+question.sid+'"/> ';
                        ...
                        if (!plugin.config.perQuestionResponseMessaging) {
                            questionHTML.append('<a href="#" class="button ' + nextQuestionClass + ' ' + checkAnswerClass + '" data-ids="'+question.id+'" q_id'+question.id+'">' + nextText + '</a>');
                        } else {
