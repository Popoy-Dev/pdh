          ...
          <div class="col-lg-8 col-md-8">
            <div class="card">
              <div class="card-body text-center" id="start">
                ...
                <button class="btn pay-tution btn-block {{ $data->quiz_type == 'id' ? 'topIdentification' : 'topicAssess'}}"
                  data-ids="{{ $data->ta_uuid }}">Start Assessment</button>
              </div>
              <div class="card-body">
                @if($data->quiz_type == 'mc' || $data->quiz_type == 'tof')
                <body id="slickQuiz">
