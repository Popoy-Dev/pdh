      ...
      <div class="page-content">
        ...
        <div class="row">
              ...
              <div class="card-body">
                ...
                <div class="tab-content mt-3 p-2" id="lineTabContent">
                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-line-tab">
                    <form id="frmEditQuiz" method="POST" data-ids="{{$data->sa_uuid}}" action="{{ url('/teacher/edit/subject-assessment').'/'. $data ? $data->sa_uuid : '' }}">
                      @csrf
                      <div class="row">
                        <div class="col-lg-10 col-md-10 ml-5">
                          <div class="form-group">
                            <label for="">Title</label>
                            <input type="text" name="quiz_title" value="{{ $data ? $data->quiz_title : '' }}" class="form-control lesson">
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control lesson" name="time_limit" value="{{$data ? $data->time_limit : ''}} Minutes">
                          </div>
          ...
          <div class="tab-pane fade " id="publish" role="tabpanel" aria-labelledby="publish-line-tab">
            <form id="addQuestion"
            method="POST"
            data-ids="{{$data->sa_uuid}}"
            action="{{ url('/teacher/add/quiz-question').'/'.$data->sa_uuid }}">
            @csrf
            <div class="row justify-content-center">
              <div class="col-lg-10 col-md-10">
                <div class="form-group row">
                  <div class="col-lg-6 col-md-6">
                    <p>Question:{{$cquestion}}/{{$data->quiz_item}}</p>
                    ...
                    <input type="text" hidden name="sa_id" value="{{ $data->id }}">
                    <input type="text" hidden id="q_type" value="{{$data->quiz_type}}" name="q_type">
                  </div>
                  <div class="col-lg-6 col-md-6">
        ...
        <div class="tab-pane fade"  id="profile" role="tabpanel" aria-labelledby="profile-line-tab">
          ...
          <div class="card">
            <div class="card-body">
              <a href="#" data-toggle="modal" data-target="#a{{$q->q_uuid}}" class="editAnswer" data-ids="{{$q->id}}">
...
<!-- //Edit Questionnaire -->
@foreach($question as $q)
<div class="modal fade" id="a{{$q->q_uuid}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered " role="document" style="max-width:400px!important;">
    <div class="modal-content">
      ...
      <form class="frmEditQuestion" method="POST" action="{{ url('/teacher/edit/quiz-question') }}">
        @csrf
        <div class="modal-body">
          <input type="text" name="ids" value="{{$q->qid}}" hidden>
          <div class="form-group">
            <label for="" class="nav-style" style="font-size:18px;">Question</label>
            <textarea name="question" rows="8" cols="80"  class="form-control questionnaire" id="question">{!! $q->question !!}</textarea>
            <div class="question"></div>
          </div>
          <?php
        ...
        <div class="modal-footer">
          ...
          <div class="col-lg-6 col-md-6">
            <form method="POST" class="frmDeleteQuestion">
              @csrf
              @method('DELETE')
              <a type="#" class="btn btn-quiz-del" style="height:35px!important;background:#ED5B5B;border-radius: 4px;
              color: #fff !important"
