              ...
              <div class="card-body">
                ...
                <div class="tab-content mt-3 p-2" id="lineTabContent">
                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-line-tab">
                    <form id="frmEditActivity" method="POST" data-ids="{{ $data->act_uuid }}"
                      action="{{ url('/teacher/edit/activity').'/'. $data->act_uuid }}">
                      @csrf
      ...
      <div class="modal-footer">
        ...
        <div class="col-lg-6 col-md-6">
          <form method="POST" class="frmDeleteQuestion">
            @csrf
            @method('DELETE')
            <a type="#" class="btn btn-del-acitivity" style="height:35px!important;background:#ED5B5B;border-radius: 4px;
            color: #fff !important"
