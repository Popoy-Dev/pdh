    ...
    <div class="col-lg-10 col-md-10">
      <div class="page-content">
              ...
              <div class="card-body">
                ...
                <div class="tab-content mt-3 p-2" id="lineTabContent">
                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-line-tab">
                    <form id="frmEditAssignment" method="POST" data-ids="{{ $data->ass_uuid }}"
                      action="{{ url('/teacher/edit/assignment').'/'. $data->ass_uuid }}">
                      @csrf
                      <div class="row justify-content-center">
                        ...
                        <div class="col-lg-10 col-md-10">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control lesson" name="quiz_type" style="border-radius:10px;">
                              ...
                              <option value="sub" {{ $data->quiz_type == 'sub' ? 'selected' : ''}}>Submission (DOCX,PDF,POWER POINT)</option>
                        ...
                        <div class="form-group ">
                          ...
                          <div class="input-group date timepicker" id="datetimepickerExample" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input" data-target="#datetimepickerExample" name="time_limit"
                            value="{{ $data ? $data->time_limit : ''}}"/>
        ...
        <div class="tab-pane fade" id="publish" role="tabpanel" aria-labelledby="publish-line-tab">
          <form id="addAssignmentQuestion"
          method="POST"
          data-ids="{{ $data->id }}"
          action="{{ url('/teacher/add/activity-question').'/'.$data->id }}">
          @csrf
          <div class="row justify-content-center">
            <div class="col-lg-10 col-md-10 ">
              ...
              <div class="form-group row">
                <div class="col-lg-6 col-md-6">
                  ...
                  <input type="text" hidden id="q_type" name="quiz_type" value="{{$data->quiz_type}}">
                </div>
                <div class="col-lg-6 col-md-6">
...
<div class="modal fade" id="topic{{$q->qid}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered " role="document" style="max-width:400px!important;">
    <div class="modal-content">
      ...
      <form
      class="frmEditAssignmentQuestion"
      method="POST"
      action="{{url('/teacher/edit/activity')}}"
      data-ids="{{$data->qid}}"
      >
      @csrf
      ...
      <div class="modal-footer">
        ...
        <div class="col-lg-6 col-md-6">
          <form method="POST" class="frmDeleteQuestion">
            @csrf
            @method('DELETE')
            <a type="#" class="btn btn-del-assignment" style="height:35px!important;background:#ED5B5B;border-radius: 4px;
            color: #fff !important"
